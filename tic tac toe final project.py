...
def main():
    ...
    while level == 1:
        # players turn
        # the users turn occurs on even numbers that aren't 0
        while players_turn % 2 == 0 and players_turn != 0:
            is_number = False
            # Pycharm says line 115 'can be simplified' but when I reformatted file the program got messed up
            ...
            if int(player_input) == 0:
                ...
                # If the user inputs a negative number, player input gets reassigned the absolute value of the input
                ...
                # verifies that input is a valid spot on the board
            if 9 >= int(player_input) > 0 and board[
                # pycharm is saying there is an error on line 136 but when I fix it the program doesnt work
            ...
            # computers turn
            # computers turn occurs when players turn is an odd number
            ...
            # in a row
                ...
                while computer_input_check == 0:
                    ...
                    if board[computer_input] == "_":
                        ...
                        var = computer_input_check == 0
    while level == 3:
        # I needed to use 'for', //,*,**, and / in my project but could not find a way to
        # implement them more naturally :(
        for x in range(int(1 // 1 * 1 ** 1 / 1)):
